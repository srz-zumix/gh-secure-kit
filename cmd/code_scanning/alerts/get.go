...
// NewGetCmd returns the code-scanning alerts get command
func NewGetCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long:  "Get a single code scanning alert by its number for a repository.",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			ctx := cmd.Context()
			alert, err := gh.GetCodeScanningAlert(ctx, client, repository, alertNumber)
			if err != nil {
